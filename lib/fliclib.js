// SEE: taken from https://raw.githubusercontent.com/50ButtonsEach/fliclib-linux-hci/master/clientlib/nodejs/fliclibNodeJs.js
...
var FlicRawClient = function(inetAddress, port) {
	...
	var closing = false;
	var socketArgs = {host: inetAddress, port: port};
	var socket = net.connect(socketArgs);
